...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class NotificationInVideoController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> Insert(NotificationInVideoCreate model)
        {
        ...
        [HttpGet]
        [Route("api/NotificationInVideo")]
        public async Task<HttpResponseMessage> GetAll([FromUri] NotificationInVideoSearch search)
        {
